document.addEventListener("DOMContentLoaded", () => {
  ...
  const navListRef = document.querySelector(".p-p-navigation-list");
  const headerRef = document.querySelector(".p-p-header");
  const navigationRef = document.querySelector(".p-p-navigation");
  ...
  document.querySelectorAll(".p-p-navigation-link").forEach((n) =>
...
function toggleAnswer(element) {
  ...
  const buttonImg = element.querySelector(".p-p-toggle-button img");
